...
const CORE_ASSETS = [
    ...
    '/styles/style.css',
    '/offline',
    '/styles/images/icons/dept-logo-512x512.png',
    '/styles/images/Header-video.png',
    '/styles/images/cases/Image.png',
    '/styles/images/cases/Image-2.png',
    '/styles/images/cases/Image-3.png',
    '/styles/images/cases/Image-4.png',
    '/styles/images/cases/Image-5.png',
    '/styles/images/cases/Image-6.png',
    '/styles/images/cases/Image-7.png',
    '/styles/images/cases/Image-8.png',
    '/styles/images/cases/Image-9.png',
    '/styles/images/cases/Image-10.png'
]
